const HeroBanner = () => {
  return (
    ...
    //         <h1 className="mt-24 text-4xl font-bold tracking-tight text-headline sm:mt-10 sm:text-6xl">
    //           Data to enrich your online business
    //         </h1>
    //         <p className="mt-6 text-lg leading-8 text-headline">
    ...
    <main>
      <div className="relative isolate">
        ...
        >
          <div
            className="aspect-[801/1036] w-[50.0625rem] bg-gradient-to-tr from-headline to-highlight opacity-30"
            style={{
              clipPath:
